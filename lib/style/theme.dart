...
class Colors {
  ...
  static const Color mainColor = const Color(0xFF1561D5);
  static const Color successGreen =const Color(0xFF32CD32);
  static const Color secondaryColor = const Color(0xFFFFCB46);
  static const Color thirdColor = const Color(0xFF091A68);
